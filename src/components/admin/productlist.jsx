                        ...
                        <tbody>
                            {products.map((product) => (
                                <tr key={product.id}>
                                    ...
                                    <td>{product.stock}</td>
                                    <td>
                                        <span className={`inline-block rounded px-2 py-0.5 text-xs font-semibold ${product.statusColor}`}>
                                            {product.status}
                                        </span>
                                    </td>
                                    <td className="pr-3 cursor-pointer">...</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
            ...
            <aside className="w-72 min-w-[290px] bg-white rounded-r-[16px] p-5 flex-col justify-between border-l border-[#d9d9d9] hidden md:flex">
                <div>
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <Button className="text-[#6b7280] hover:text-[#0a1217]">
                    ...
                    <div className="flex flex-col items-center mb-6">
                        ...
                        <p className="text-sm text-[#6b7280]">{products[0].category}</p>
                        <span className={`inline-block rounded px-2 py-0.5 text-xs font-semibold ${products[0].statusColor}`}>
                            {products[0].status}
                        </span>
                        <p className="text-xs text-[#6b7280]">Stock: {products[0].stock}</p>
                    </div>
